...
const quizQuestions = [
    { type: "truefalse", question: "JavaScript är ett objektorienterat programmeringsspråk.", correctAnswer: "falskt" },
    { type: "truefalse", question: "JavaScript kan användas för att manipulera HTML-dokument.", correctAnswer: "sant" },
    ...
    { type: "truefalse", question: "JavaScript använder strikt typning, vilket betyder att du inte kan ändra en variabels datatyp.", correctAnswer: "falskt" },
    { type: "truefalse", question: "En funktion i JavaScript kan anropas innan den deklareras om den deklareras med `function`-nyckelordet.", correctAnswer: "sant" },
...
function loadQuestion() {
    ...
    if (q.type === "truefalse") {
        div.innerHTML += `<label><input type="radio" name="q" value="sant"> Sant</label>`;
        div.innerHTML += `<label><input type="radio" name="q" value="falskt"> Falskt</label>`;
...
function submitQuiz() {
    ...
    resultMessage.className = `final-result-message ${resultClass}`;
